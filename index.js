            ...
            if (interaction.commandName == 'move') {
                ...
                if (current_character[0].length > 0) {
                    if (interaction.options.getSubcommand == 'display') {
                        ...
                        var characterskills = await connection.promise().query('select s.* from skills_characters sc join skills s on cs.skill_id = s.id where cs.character_id = ? and s.targetable = 1', [current_character[0][0].character_id]);
