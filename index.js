            ...
            if (interaction.options.getSubcommand() === 'add') {
                ...
                collector.on('collect', async (interaction_second) => {
                    if (interaction_second.customId == 'RepSelector') {
                        ...
                        if (reputations[0].length > 0) {
                            interaction.update({ content: 'A reputation tier with this name already exists for this reputation.' });
                        } else {
                            ...
                            if (reputation[0][0].maximum < value) {
                                interaction.update({ content: 'You entered a reputation tier minimum value higher than this reputation\'s maximum value.' });
                            } else {
                                ...
                                interaction.update({ content: "Reputation tier added." });
                            }
                        }
                        //add tier
